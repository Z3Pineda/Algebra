#!/usr/bin/env python3
"""Integra Diferencia.mp4 (Manim, sin audio) con 6 bloques MP3 usando ffmpeg."""
...
OUTPUT = ROOT / "video_1_7_final.mp4"

VIDEO_CANDIDATES = [
    ROOT / "Diferencia.mp4",
    ROOT / "media" / "videos" / "video_1_7_diferencia" / "1080p60" / "Diferencia.mp4",
]
...
def buscar_video() -> Path:
    for candidato in VIDEO_CANDIDATES:
        if candidato.exists():
            return candidato
    print("ERROR: No se encontro Diferencia.mp4")
    print("Renderiza primero:")
    print("  manim -pqh video_1_7_diferencia.py Diferencia")
    sys.exit(1)
...
def main() -> None:
    print("=" * 50)
    print("Integracion Video 1.7 — Diferencia")
    print("=" * 50)
    print()
