#!/usr/bin/env python3
"""Integra Interseccion.mp4 (Manim, sin audio) con 5 bloques MP3 usando ffmpeg."""
...
OUTPUT = ROOT / "video_1_6_final.mp4"

VIDEO_CANDIDATES = [
    ROOT / "Interseccion.mp4",
    ROOT / "media" / "videos" / "video_1_6_interseccion" / "1080p60" / "Interseccion.mp4",
]
...
def buscar_video() -> Path:
    for candidato in VIDEO_CANDIDATES:
        if candidato.exists():
            return candidato
    print("ERROR: No se encontro Interseccion.mp4")
    print("Renderiza primero:")
    print("  manim -pqh video_1_6_interseccion.py Interseccion")
    sys.exit(1)
...
def main() -> None:
    print("=" * 50)
    print("Integracion Video 1.6 — Interseccion")
    print("=" * 50)
    print()
