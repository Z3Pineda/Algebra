#!/usr/bin/env python3
"""Integra ConjuntosNumericos.mp4 (Manim, sin audio) con 7 bloques MP3 usando ffmpeg."""
...
OUTPUT = ROOT / "video_conjuntos_numericos_final.mp4"

VIDEO_CANDIDATES = [
    ROOT / "ConjuntosNumericos.mp4",
    ROOT
    / "media"
    / "videos"
    / "video_conjuntos_numericos"
    / "1080p60"
    / "ConjuntosNumericos.mp4",
]
...
def buscar_video() -> Path:
    for candidato in VIDEO_CANDIDATES:
        if candidato.exists():
            return candidato
    print("ERROR: No se encontro ConjuntosNumericos.mp4")
    print("Renderiza primero:")
    print("  manim -pqh video_conjuntos_numericos.py ConjuntosNumericos")
    sys.exit(1)
...
def main() -> None:
    print("=" * 50)
    print("Integracion — ConjuntosNumericos + 7 audios")
    print("=" * 50)
    print()
