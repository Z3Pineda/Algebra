#!/usr/bin/env python3
"""Integra Union.mp4 (Manim, sin audio) con 5 bloques MP3 usando ffmpeg."""
...
OUTPUT = ROOT / "video_1_5_final.mp4"

VIDEO_CANDIDATES = [
    ROOT / "Union.mp4",
    ROOT / "media" / "videos" / "video_1_5_union" / "1080p60" / "Union.mp4",
]
...
def buscar_video() -> Path:
    for candidato in VIDEO_CANDIDATES:
        if candidato.exists():
            return candidato
    print("ERROR: No se encontro Union.mp4")
    print("Renderiza primero:")
    print("  manim -pqh video_1_5_union.py Union")
    sys.exit(1)
...
def main() -> None:
    print("=" * 50)
    print("Integracion Video 1.5 — Union")
    print("=" * 50)
    print()
