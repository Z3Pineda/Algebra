...
def render_gs(title: str, description: str, exercises: list[dict]) -> str:
    ...
    lines.append("  form.setLimitOneResponsePerUser(true);")
    lines.append("")
    lines.append('  var nom = form.addTextItem();')
    lines.append('  nom.setTitle("Nombre completo");')
    lines.append('  nom.setHelpText("Escribe tu nombre como aparece en la lista de clase.");')
    lines.append("  nom.setRequired(true);")
    lines.append("")
    lines.append('  var mat = form.addTextItem();')
