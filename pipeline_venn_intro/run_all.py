#!/usr/bin/env python3
"""
Pipeline — Introducción al diagrama de Venn (VennIntro)
...
MANIM_SCRIPT = ROOT / "video_venn_intro.py"
SCENE = "VennIntro"
MANIM_OUTPUT = (
    ROOT / "media" / "videos" / "video_venn_intro" / "1080p60" / f"{SCENE}.mp4"
)
FINAL_OUTPUT = ROOT / "video_venn_intro_final.mp4"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Pipeline VennIntro")
    parser.add_argument("--skip-sync", action="store_true")
    parser.add_argument(
        "--skip-manim",
        action="store_true",
        help="Omitir render si ya existe VennIntro.mp4",
    )
    args = parser.parse_args()

    print("=" * 60)
    print("Pipeline — Introduccion al diagrama de Venn")
    print("=" * 60)
    print()
