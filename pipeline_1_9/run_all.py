#!/usr/bin/env python3
"""
Pipeline completo Video 1.9 — Inclusion-Exclusion
...
MANIM_SCRIPT = ROOT / "video_1_9_inclusion_exclusion.py"
SCENE = "InclusionExclusion"
MANIM_OUTPUT = (
    ROOT
    / "media"
    / "videos"
...
FINAL_OUTPUT = ROOT / "video_1_9_final.mp4"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Pipeline Video 1.9 — Inclusion-Exclusion")
    parser.add_argument("--skip-sync", action="store_true")
    parser.add_argument("--skip-manim", action="store_true")
    args = parser.parse_args()

    print("=" * 60)
    print("Pipeline Video 1.9 — Inclusion-Exclusion")
    print("=" * 60)
    print()
