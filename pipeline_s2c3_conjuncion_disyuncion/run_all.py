#!/usr/bin/env python3
"""Pipeline — S2·C3 Conjuncion y disyuncion."""
...
MANIM_SCRIPT = ROOT / "video_s2c3_conjuncion_disyuncion.py"
SCENE = "ConjuncionDisyuncion"
MANIM_OUTPUT = ROOT / "media" / "videos" / "video_s2c3_conjuncion_disyuncion" / "1080p60" / f"{SCENE}.mp4"
FINAL_OUTPUT = ROOT / "video_s2c3_conjuncion_disyuncion_final.mp4"
...
def main() -> None:
    ...
    print("=" * 60)
    print("Pipeline — S2·C3 Conjuncion y disyuncion")
    print("=" * 60)
