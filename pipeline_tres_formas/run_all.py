#!/usr/bin/env python3
"""
Pipeline — Tres formas de representar un conjunto (TresFormas)

Pasos:
  0. Calcular section_starts desde audios (ffprobe)
  1. Render Manim (1080p60)
  2. Integrar 6 audios con ffmpeg
...
MANIM_SCRIPT = ROOT / "video_tres_formas.py"
SCENE = "TresFormas"
MANIM_OUTPUT = (
    ROOT / "media" / "videos" / "video_tres_formas" / "1080p60" / f"{SCENE}.mp4"
)
FINAL_OUTPUT = ROOT / "video_tres_formas_final.mp4"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Pipeline TresFormas")
    parser.add_argument("--skip-sync", action="store_true")
    parser.add_argument(
        "--skip-manim",
        action="store_true",
        help="Omitir render si ya existe TresFormas.mp4",
    )
    args = parser.parse_args()

    print("=" * 60)
    print("Pipeline — Tres formas de representar un conjunto")
    print("=" * 60)
    print()
