#!/usr/bin/env python3
"""
Pipeline completo Video 1.4 — Pertenencia

Pasos:
  0. Calcular section_starts.json desde audios/ (ffprobe)
  1. Render Manim (Pertenencia, 1080p60) — usa section_starts.json
  2. Integrar MP3 con ffmpeg → video_1_4_final.mp4
...
MANIM_SCRIPT = ROOT / "video_1_4_pertenencia.py"
SCENE = "Pertenencia"
MANIM_OUTPUT = (
    ROOT / "media" / "videos" / "video_1_4_pertenencia" / "1080p60" / f"{SCENE}.mp4"
)
FINAL_OUTPUT = ROOT / "video_1_4_final.mp4"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Pipeline Video 1.4 — Pertenencia")
    parser.add_argument("--skip-sync", action="store_true")
    parser.add_argument("--skip-manim", action="store_true")
    args = parser.parse_args()

    print("=" * 60)
    print("Pipeline Video 1.4 — Pertenencia")
    print("=" * 60)
    print()
