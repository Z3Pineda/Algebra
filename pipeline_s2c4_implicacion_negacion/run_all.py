#!/usr/bin/env python3
"""Pipeline — S2·C4 Implicacion y negacion."""
...
MANIM_SCRIPT = ROOT / "video_s2c4_implicacion_negacion.py"
SCENE = "ImplicacionNegacion"
MANIM_OUTPUT = ROOT / "media" / "videos" / "video_s2c4_implicacion_negacion" / "1080p60" / f"{SCENE}.mp4"
FINAL_OUTPUT = ROOT / "video_s2c4_implicacion_negacion_final.mp4"
...
def main() -> None:
    ...
    print("=" * 60)
    print("Pipeline — S2·C4 Implicacion y negacion")
    print("=" * 60)
