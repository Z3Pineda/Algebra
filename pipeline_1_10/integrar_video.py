#!/usr/bin/env python3
"""Integra VennConteo.mp4 (Manim, sin audio) con 6 bloques MP3 usando ffmpeg."""
...
OUTPUT = ROOT / "video_1_10_final.mp4"

VIDEO_CANDIDATES = [
    ROOT / "VennConteo.mp4",
    ROOT / "media" / "videos" / "video_1_10_venn_conteo" / "1080p60" / "VennConteo.mp4",
]
...
def buscar_video() -> Path:
    for candidato in VIDEO_CANDIDATES:
        if candidato.exists():
            return candidato
    print("ERROR: No se encontro VennConteo.mp4")
    print("Renderiza primero:")
    print("  manim -pqh video_1_10_venn_conteo.py VennConteo")
    sys.exit(1)
...
def main() -> None:
    print("=" * 50)
    print("Integracion Video 1.10 — VennConteo")
    print("=" * 50)
    print()
