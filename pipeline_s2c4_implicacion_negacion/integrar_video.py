#!/usr/bin/env python3
"""Integra ImplicacionNegacion.mp4 con 10 bloques MP3."""
...
OUTPUT = ROOT / "video_s2c4_implicacion_negacion_final.mp4"

VIDEO_CANDIDATES = [
    ROOT / "ImplicacionNegacion.mp4",
    ROOT / "media" / "videos" / "video_s2c4_implicacion_negacion" / "1080p60" / "ImplicacionNegacion.mp4",
]
...
def buscar_video() -> Path:
    for candidato in VIDEO_CANDIDATES:
        if candidato.exists():
            return candidato
    print("ERROR: No se encontro ImplicacionNegacion.mp4")
    sys.exit(1)
...
def main() -> None:
    print("=" * 50)
    print("Integracion — ImplicacionNegacion + 10 audios")
    print("=" * 50)
    final = integrar()
    print()
    print("=" * 50)
