#!/usr/bin/env python3
"""
Pipeline completo Video 1.2 — Extension

Pasos:
  0. Calcular section_starts.json desde audio/ (ffprobe)
  1. Render Manim (Extension, 1080p60) — usa section_starts.json
  2. Integrar MP3 con ffmpeg → video_1_2_final.mp4
...
MANIM_SCRIPT = ROOT / "video_1_2_extension.py"
SCENE = "Extension"
MANIM_OUTPUT = (
    ROOT / "media" / "videos" / "video_1_2_extension" / "1080p60" / f"{SCENE}.mp4"
)
FINAL_OUTPUT = ROOT / "video_1_2_final.mp4"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Pipeline Video 1.2 — Extension")
    parser.add_argument(
        "--skip-sync",
        action="store_true",
    ...
    print("=" * 60)
    print("Pipeline Video 1.2 — Extension")
    print("=" * 60)
    print()
