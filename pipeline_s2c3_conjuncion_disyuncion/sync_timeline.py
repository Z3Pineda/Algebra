#!/usr/bin/env python3
"""Linea de tiempo compartida entre Manim e integrar_video — ConjuncionDisyuncion."""
...
AUDIO_FILES = [f"s2c3_bloque{i}.mp3" for i in range(1, 10)]

SECTION_TITLES = [
    "Apertura prensa y alarma",
    "Conjuncion",
    "Prensa interlock",
    "Disyuncion",
    "Sistema alarma",
