#!/usr/bin/env python3
"""Integra ConjuntoPiezas.mp4 (Manim, sin audio) con 7 bloques MP3 usando ffmpeg."""
...
OUTPUT = ROOT / "video_conjuntos_piezas_final.mp4"

VIDEO_CANDIDATES = [
    ROOT / "ConjuntoPiezas.mp4",
    ROOT
    / "media"
    / "videos"
...
def buscar_video() -> Path:
    for candidato in VIDEO_CANDIDATES:
        if candidato.exists():
            return candidato
    print("ERROR: No se encontro ConjuntoPiezas.mp4")
    print("Renderiza primero:")
    print("  manim -pqh video_conjuntos_piezas.py ConjuntoPiezas")
    sys.exit(1)
...
def main() -> None:
    print("=" * 50)
    print("Integracion — ConjuntoPiezas + 7 audios")
    print("=" * 50)
    print()
