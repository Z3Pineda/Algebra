#!/usr/bin/env python3
"""
Integra Extension.mp4 (Manim, sin audio) con 5 bloques MP3 usando ffmpeg.
...
OUTPUT = ROOT / "video_1_2_final.mp4"
...
def buscar_video() -> Path:
    for candidato in VIDEO_CANDIDATES:
        if candidato.exists():
            return candidato
    print("ERROR: No se encontro Extension.mp4")
    print("  Buscado en:")
    for candidato in VIDEO_CANDIDATES:
        print(f"    - {candidato}")
    print()
    print("Renderiza primero:")
    print("  manim -pqh video_1_2_extension.py Extension")
    sys.exit(1)
...
def main() -> None:
    print("=" * 50)
    print("Integracion Video 1.2 — Extension")
    print("=" * 50)
    print()
