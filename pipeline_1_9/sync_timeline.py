#!/usr/bin/env python3
"""Linea de tiempo compartida entre Manim e integrar_video (Video 1.9)."""
...
SECTION_TITLES = [
    ...
    "Por que no basta sumar",
    "La formula parte por parte",
    "Aplicacion numerica",
    "Errores comunes",
    "Cierre",
]
...
def cargar_section_starts() -> list[float]:
    if not SYNC_FILE.exists():
        return [0.0, 15.0, 40.0, 75.0, 105.0, 130.0]
