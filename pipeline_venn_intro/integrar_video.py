#!/usr/bin/env python3
"""Integra VennIntro.mp4 (Manim, sin audio) con 7 bloques MP3 usando ffmpeg."""
...
OUTPUT = ROOT / "video_venn_intro_final.mp4"

VIDEO_CANDIDATES = [
    ROOT / "VennIntro.mp4",
    ROOT / "media" / "videos" / "video_venn_intro" / "1080p60" / "VennIntro.mp4",
]
...
def buscar_video() -> Path:
    for candidato in VIDEO_CANDIDATES:
        if candidato.exists():
            return candidato
    print("ERROR: No se encontro VennIntro.mp4")
    print("Renderiza primero:")
    print("  manim -pqh video_venn_intro.py VennIntro")
    sys.exit(1)
...
def main() -> None:
    print("=" * 50)
    print("Integracion — VennIntro + 7 audios")
    print("=" * 50)
    print()
