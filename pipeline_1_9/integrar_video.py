#!/usr/bin/env python3
"""Integra InclusionExclusion.mp4 (Manim, sin audio) con 6 bloques MP3 usando ffmpeg."""
...
OUTPUT = ROOT / "video_1_9_final.mp4"

VIDEO_CANDIDATES = [
    ROOT / "InclusionExclusion.mp4",
    ROOT
    / "media"
    / "videos"
    / "video_1_9_inclusion_exclusion"
    / "1080p60"
    / "InclusionExclusion.mp4",
]
...
def buscar_video() -> Path:
    for candidato in VIDEO_CANDIDATES:
        if candidato.exists():
            return candidato
    print("ERROR: No se encontro InclusionExclusion.mp4")
    print("Renderiza primero:")
    print("  manim -pqh video_1_9_inclusion_exclusion.py InclusionExclusion")
    sys.exit(1)
...
def main() -> None:
    print("=" * 50)
    print("Integracion Video 1.9 — Inclusion-Exclusion")
    print("=" * 50)
    print()
