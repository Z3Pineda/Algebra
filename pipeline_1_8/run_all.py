#!/usr/bin/env python3
"""
Pipeline completo Video 1.8 — Complemento de conjuntos
...
MANIM_SCRIPT = ROOT / "video_1_8_complemento.py"
SCENE = "Complemento"
MANIM_OUTPUT = (
    ROOT / "media" / "videos" / "video_1_8_complemento" / "1080p60" / f"{SCENE}.mp4"
)
FINAL_OUTPUT = ROOT / "video_1_8_final.mp4"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Pipeline Video 1.8 — Complemento")
    parser.add_argument("--skip-sync", action="store_true")
    parser.add_argument("--skip-manim", action="store_true")
    args = parser.parse_args()

    print("=" * 60)
    print("Pipeline Video 1.8 — Complemento de conjuntos")
    print("=" * 60)
    print()
