#!/usr/bin/env python3
"""Integra Proposicion.mp4 (Manim, sin audio) con 7 bloques MP3 usando ffmpeg."""
...
OUTPUT = ROOT / "video_s2c1_proposicion_final.mp4"

VIDEO_CANDIDATES = [
    ROOT / "Proposicion.mp4",
    ROOT / "media" / "videos" / "video_s2c1_proposicion" / "1080p60" / "Proposicion.mp4",
]
...
def buscar_video() -> Path:
    for candidato in VIDEO_CANDIDATES:
        if candidato.exists():
            return candidato
    print("ERROR: No se encontro Proposicion.mp4")
    sys.exit(1)
...
def main() -> None:
    print("=" * 50)
    print("Integracion — Proposicion + 7 audios")
    print("=" * 50)
    final = integrar()
    print()
    print("=" * 50)
