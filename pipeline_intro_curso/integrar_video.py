#!/usr/bin/env python3
"""Integra IntroCurso.mp4 (Manim, sin audio) con 4 bloques MP3 usando ffmpeg."""
...
OUTPUT = ROOT / "video_intro_curso_final.mp4"

VIDEO_CANDIDATES = [
    ROOT / "IntroCurso.mp4",
    ROOT / "media" / "videos" / "video_intro_curso" / "1080p60" / "IntroCurso.mp4",
]
...
def buscar_video() -> Path:
    for candidato in VIDEO_CANDIDATES:
        if candidato.exists():
            return candidato
    print("ERROR: No se encontro IntroCurso.mp4")
    print("Renderiza primero:")
    print("  manim -pqh video_intro_curso.py IntroCurso")
    sys.exit(1)
...
def main() -> None:
    print("=" * 50)
    print("Integracion — IntroCurso + 4 audios")
    print("=" * 50)
    print()
