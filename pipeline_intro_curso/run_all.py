#!/usr/bin/env python3
"""
Pipeline — Introduccion al curso de Algebra (IntroCurso)

Pasos:
  0. Calcular section_starts desde audios (ffprobe)
  1. Render Manim (1080p60)
  2. Integrar 4 audios con ffmpeg
...
MANIM_SCRIPT = ROOT / "video_intro_curso.py"
SCENE = "IntroCurso"
MANIM_OUTPUT = (
    ROOT / "media" / "videos" / "video_intro_curso" / "1080p60" / f"{SCENE}.mp4"
)
FINAL_OUTPUT = ROOT / "video_intro_curso_final.mp4"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Pipeline IntroCurso")
    parser.add_argument("--skip-sync", action="store_true")
    parser.add_argument(
        "--skip-manim",
        action="store_true",
        help="Omitir render si ya existe IntroCurso.mp4",
    )
    args = parser.parse_args()

    print("=" * 60)
    print("Pipeline — Introduccion al curso de Algebra")
    print("=" * 60)
    print()
