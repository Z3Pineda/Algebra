#!/usr/bin/env python3
"""Integra Complemento.mp4 (Manim, sin audio) con 5 bloques MP3 usando ffmpeg."""
...
OUTPUT = ROOT / "video_1_8_final.mp4"

VIDEO_CANDIDATES = [
    ROOT / "Complemento.mp4",
    ROOT / "media" / "videos" / "video_1_8_complemento" / "1080p60" / "Complemento.mp4",
]
...
def buscar_video() -> Path:
    for candidato in VIDEO_CANDIDATES:
        if candidato.exists():
            return candidato
    print("ERROR: No se encontro Complemento.mp4")
    print("Renderiza primero:")
    print("  manim -pqh video_1_8_complemento.py Complemento")
    sys.exit(1)
...
def main() -> None:
    print("=" * 50)
    print("Integracion Video 1.8 — Complemento")
    print("=" * 50)
    print()
